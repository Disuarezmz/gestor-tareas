// Projects list + Settings variations
...
function ProjectsC() {
  // Galaxia/orbital — atrevido. Proyectos como círculos cuyo tamaño = nº de tareas
  const items = [
            ...
            <div style={{ padding: '4px 22px 22px', overflow: 'hidden', display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                ...
                <Field label="Zona horaria">
                  <Select value={<Mono color={wfTokens.text}>Europe/Madrid · UTC+2</Mono>} />
                </Field>
                <Field label="Idioma">
                  <Select value={<Mono color={wfTokens.text}>Español</Mono>} />
                </Field>
              </div>
              ...
              <SB style={{ padding: 14, display: 'flex', flexDirection: 'column', gap: 10 }}>
                ...
                <Row label="Vista por defecto al abrir"><Select value="Tablero" /></Row>
              </SB>
            </div>
          </div>
        </div>
...
Object.assign(window, { ProjectsA, ProjectsB, ProjectsC, SettingsA, SettingsB });
