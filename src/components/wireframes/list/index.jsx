...
import { Page, Mono, SB, L, Dot, StateDot, StatePill, Prio, Tag, Btn, Check, Ic, HW } from '../../primitives/index.jsx';
import { TopBar, Sidebar, PageTitle, TaskCard } from '../../chrome/index.jsx';
          ...
          <div style={{ padding: '0 22px 22px', flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
            <SB style={{ padding: 0, flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
              <div style={{
                ...
                <div /><div>Tarea</div><div>Estado</div><div>Proyecto</div>
                <div>Etiquetas</div><div>Fecha</div><div>Prio</div><div />
              </div>
              ...
              <SB key={i} hi style={{ padding: 12, borderLeft: `3px solid ${stateColor(s)}`, display: 'flex', alignItems: 'center', gap: 14 }}>
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 5 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, fontSize: 10, color: wfTokens.textMuted }}>
                    ...
                    <div style={{ display: 'flex', gap: 4 }}>{tg.map((tag, j) => <Tag key={j}>{tag}</Tag>)}</div>
                  </div>
                </div>
                <Ic d={I.more} size={12} />
              </SB>
